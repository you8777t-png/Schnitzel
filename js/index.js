...
function atualizarTelaBanco() {
    ...
    if (jogador.pixPendentes.length > 0) {
        ...
        jogador.pixPendentes.forEach((pix, index) => {
            ...
            div.innerHTML = `<div><span style="font-size: 0.7rem; color: #adb5bd;">De: ${pix.de}</span><br><strong>S$ ${pix.valor}</strong></div><button class="btn-primario" style="margin:0; padding: 5px 10px; font-size: 0.8rem; background: #00ff88; color: